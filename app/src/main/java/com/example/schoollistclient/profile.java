...
public class profile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button buttonList = view.findViewById(R.id.Go_to_list); // Переход на фрагмент с журналом
        buttonList.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.action_profile_to_list_edit));
